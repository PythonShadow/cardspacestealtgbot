...
TOKEN = '1407978869:AAEe-y_2vvi7K6AfE2up4Wnvik_8GTezMmI'

chat_ids_file = 'chat_ids.txt'
vip_id_file = 'chat_ids.txt'

ADMIN_CHAT_ID = 1128393901 #ваш id телеграма(цифрами)
    ...
    if call.message:
        ...
        if call.data == "tgbot":
            ...
            bot.send_message(message.chat.id,
                             "🖖Приветствую тебя! \n Это бот канала <b>CARD SPACE</b>: @cardspace\n\nПо вопросам и т.п: @shadyfeedback_bot",
                             parse_mode="HTML")
